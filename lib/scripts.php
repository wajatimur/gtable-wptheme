...
function roots_scripts() {
  ...
  wp_enqueue_style('roots_prettify', get_template_directory_uri() . '/assets/css/prettify.css', false, null);
  ...
  wp_register_script('roots_vendor_prettify', get_template_directory_uri() . '/assets/js/vendor/prettify.js', false, null, false);
  ...
  wp_enqueue_script('roots_vendor_prettify');
